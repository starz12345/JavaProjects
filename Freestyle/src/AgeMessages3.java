...
public class AgeMessages3 {
	...
	public static void main(String[] args) {
		...
		if ( age < 16 )	System.out.println(a + ", " + name + ".");
		if ( 18 > age && age >= 16) System.out.println(b + ", " + name + ".");
		if( 25 > age && age >= 18 ) System.out.println(c + ", " + name + ".");
		if (age >= 25) System.out.println(d + ", " + name + ".");
